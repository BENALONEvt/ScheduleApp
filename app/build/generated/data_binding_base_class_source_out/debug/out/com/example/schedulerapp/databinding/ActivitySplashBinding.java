...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  private ActivitySplashBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageLogo,
      @NonNull ProgressBar progressBar, @NonNull ConstraintLayout splashContainer,
      @NonNull TextView textAppName, @NonNull ViewPager2 viewPager) {
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySplashBinding((ConstraintLayout) rootView, imageLogo, progressBar,
          splashContainer, textAppName, viewPager);
    }
